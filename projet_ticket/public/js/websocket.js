...
var gameId = 4;
e["private"]('partie.' + gameId).listen('PlayerJoined', function (event) {
  var playerCount = document.getElementById('playerCount');
  playerCount.textContent = parseInt(playerCount.textContent) + 1;
});
e["private"]('partie.' + gameId).listen('PlayerLeft', function (event) {
  var playerCount = document.getElementById('playerCount');
  playerCount.textContent = parseInt(playerCount.textContent) - 1;
});
e["private"]('partie.' + gameId).listen('LauchEvent', function (event) {
